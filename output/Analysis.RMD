...
plot5 <- plot_ly(x = SalesPop$sales , y = SalesPop$population,  plot_bgcolor="blue", size =SalesPop$NumberofRestrooms/SalesPop$population  , color=SalesPop$borough, mode = "markers")
```
